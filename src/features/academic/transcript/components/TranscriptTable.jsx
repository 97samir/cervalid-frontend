        ...
        return (
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body text-center py-5 px-3">
                    ...
                    <h5 className="mt-3">
                        No existen historiales académicos
                    </h5>

                    <p className="text-muted mb-4">
                        Cree el primer historial académico del
                        estudiante para comenzar a registrar sus
                        períodos.
                    </p>
